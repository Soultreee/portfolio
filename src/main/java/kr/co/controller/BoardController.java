...
public class BoardController {
	...
	/*
	 * // 게시판 목록 조회 10.게시판 페이징 구현을 위한 수정
	 * 
	...
	/*
	 * // 게시판 목록 조회 10.게시판 페이징 구현을 위한 수정 pagemaker 추가
	 * 
	 * @RequestMapping(value = "/list", method = RequestMethod.GET) public String
	...
	// 게시판 목록 조회 11 게시판 검색 기능 구현을 위한 수정
	/*
	 * @RequestMapping(value = "/list", method = RequestMethod.GET) public String
	 * list(Model model, Criteria cri) throws Exception{ logger.info("list");
	 * 
	...
	/*
	 * // 게시판 조회 12 게시판 페이징 검색 유지를 위한 수정
	 * 
	 ...
	 */
	// 게시판 조회 13 게시판 댓글 목록 구현을 위한 replyList 추가
	...
	// 게시판 수정뷰 12 게시판 페이징 검색 유지를 위한 수정
	/*
	...
	/*
	 * // 게시판 수정 12 게시판 페이징 검색 유지를 위한 수정
	 * 
	...
	/*
	 * // 게시판 삭제 12 게시판 페이징 검색 유지를 위한 수정
	 * 
